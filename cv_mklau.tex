...
\item Lau~MK, Lamit~LJ and Whitham~TG (In Prep) Genotypic variation in
  ...
  structure. 
\item Naesborg~R, Lau~MK, Williams~C, Michalet~R, Whitham~TG (In
  Prep) Tree genes affect rock lichen and plant understory
  communities: An example of trophic-independent interactions. 
\item Ma~T, Liang~Y, Sunde~M, Lau~MK, Liu~B, Wu~M, He~H (SUBMITTED)
