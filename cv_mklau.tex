...
\begin{itemize}
\item Adjunct Profressor, Lasell University, 2019
\item Postdoctoral Research Fellow, Institute of Applied Ecology,
  Chinese Academy of Science, 2019
\item External Research Fellow, Harvard University, 2018-2019
\item
...
\item 
  ...
  Sanders~NJ, Dunn~R and Helms~Cahan~S (2019) Expanded view of the
  ecological genomics of ant responses to climate
  change. PeerJ. Accepted.
\item 
...
\begin{itemize}
\item Chang Chun
\item Lau~MK (2019) Evolution of Ecological Networks in the
  Anthropocene. Institute of Applied Ecology, Chinese Academy of
...
\item Lau~MK (2018) Automated code cleaning can help address the
  ...
  Harvard University.
\item Lau~MK (2018) CAS.
\item Lau~MK (2018) Xian.
