...
\item Lau~MK, Lamit~LJ, Borrett~SR, Bowker~MA, Naesbourg~R, Whitham~TG
  (In Review at \ttextit{Nature Ecology and Evolution}) Genotypic
...
\item Trisoviç~A, Pasquier~TFJ-M, Lau~MK, Seltzer~M, Crocas~M (In
  Review at \textit{Nature Scientific Data}) A large-scale study on
  quality and reproducibility of research outputs in R. Nature
  Scientific Data.
\item Naesborg~R, Lau~MK, Michalet~R, Williams~C, Whitham~TG (In
  Review at \textit{Ecology}) Tree genes affect rock lichen and plant
  understory communities: An example of trophic-independent
  interactions. Journal of Ecology.
