...
\\
Email: mk@mklau.info \\
Website: \url{people.fas.harvard.edu/~matthewklau} \\
LinkedIn: \url{www.linkedin.com/in/mklau-info/} \\
ResearchGate: \\ \url{www.researchgate.net/profile/Matthew_Lau2} \\
...
\item External Reseaerch Fellow (Harvard University), 2018--Present
\item
...
\item Lau~MK, Liang~Y (In Prep) Review of the application of network
  ...
  input-output models.
\item Lau~MK, Lamit~LJ, Borrett~SR, Bower~MA, Naesbourg~R, Whitham~TG
  (In Prep) Genotypic variation in a foundation tree species
  influences lichen interaction network structure.
\item Trisoviç~A, Pasquier~TFJ-M, Lau~MK, Seltzer~M, Crocas~M (In
  Prep) A large-scale study on quality and reproducibility of research
  outputs in R. Nature Scientific Data.
\item Naesborg~R, Lau~MK, Michalet~R, Williams~C, Whitham~TG (In
  Review) Tree genes affect rock lichen and plant understory
  communities: An example of trophic-independent interactions. Journal
  of Ecology.
\item Ma~T, Liang~Y, Sunde~M, Lau~MK, Liu~B, Wu~M, He~H (In Review)
...
\item Liu~B, Biswas~S, Yang~J, Liu~Z, He~H, Liang~Y, Lau~MK, Fang~Y, and
  Han~S (2020) Forest Ecology and Management. 473: 118307.
...
\begin{itemize}
\item Automatic Code Cleaning in R with Rclean (2020) ROpenSci Blog
  Post.
\item
